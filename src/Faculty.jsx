...
const faculty = [
    ...
    { 
        ...
        qual : " M.Tech  SET" ,
        description : " Assistant Professior (PSTC) @Computer Science Department in Rgukt Nuzvid",
    ...
    { 
        ...
        name : "Mr.Bapi Raju" ,
        qual : " M.Sc  SLET" ,
        description : " Assistant Professior (MATHS) @Computer Science Department in Rgukt Nuzvid",
    ...
    { 
         ...
         name : "Mr. Satya Dev",
         qual : " MA  SET",
         description : " Assistant Professior (EGCD) @Mechanical Engineer in Rgukt  Nuzvid",
